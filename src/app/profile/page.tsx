    ...
    () => [
      {
        ...
        items: [
            ...
            ? [
                {
                  ...
                  label: "My Orders",
                  sublabel: "View order history and reorder",
          ...
          },
          {
            ...
            label: "Payments",
            sublabel: "Saved cards and UPI",
            href: "/profile/payments" as const,
          },
        ],
      },
      {
        ...
        items: [
          {
            icon: <Bell size={20} />,
            label: "Notifications",
            sublabel: "Order updates and offers",
            href: "/profile/notifications" as const,
          },
          {
            icon: <ShieldCheck size={20} />,
            label: "Privacy & Security",
            sublabel: "Password and data settings",
          ...
          <div key={idx}>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm divide-y divide-gray-50">
              {section.items.map((item, itemIdx) => {
                const rowClass =
                  "w-full p-5 flex items-center justify-between hover:bg-gray-50 transition-colors text-left group";
                const inner = (
                  <>
                ...
                return "href" in item && item.href ? (
                  <Link key={itemIdx} href={item.href} className={rowClass}>
                    {inner}
                  </Link>
                ) : (
                  <button key={itemIdx} type="button" className={rowClass}>
                    {inner}
                  </button>
                );
              })}
